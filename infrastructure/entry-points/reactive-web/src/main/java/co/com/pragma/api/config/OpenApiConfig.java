...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI(
            @Value("${application.name:pragma-solicitud-management}") String appName,
            @Value("${application.description:API para administración de solicitudes}") String appDescription,
